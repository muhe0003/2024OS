...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003ce:	06f76963          	bltu	a4,a5,80200440 <interrupt_handler+0x7c>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020042a:	00d78c63          	beq	a5,a3,80200442 <interrupt_handler+0x7e>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200430:	6402                	ld	s0,0(sp)
    80200432:	0141                	addi	sp,sp,16
    80200434:	8082                	ret
            cprintf("Supervisor external interrupt\n");
    80200436:	00001517          	auipc	a0,0x1
    8020043a:	b1a50513          	addi	a0,a0,-1254 # 80200f50 <etext+0x524>
    8020043e:	b90d                	j	80200070 <cprintf>
            print_trapframe(tf);
    80200440:	b715                	j	80200364 <print_trapframe>
		    num+=1;
    80200442:	00004417          	auipc	s0,0x4
    80200446:	bd640413          	addi	s0,s0,-1066 # 80204018 <num>
    8020044a:	601c                	ld	a5,0(s0)
    cprintf("%d ticks\n", TICK_NUM);
    8020044c:	06400593          	li	a1,100
    80200450:	00001517          	auipc	a0,0x1
    80200454:	af050513          	addi	a0,a0,-1296 # 80200f40 <etext+0x514>
		    num+=1;
    80200458:	0785                	addi	a5,a5,1
    8020045a:	e01c                	sd	a5,0(s0)
    cprintf("%d ticks\n", TICK_NUM);
    8020045c:	c15ff0ef          	jal	ra,80200070 <cprintf>
		    ticks=0;
    80200460:	00004797          	auipc	a5,0x4
    80200464:	ba07b823          	sd	zero,-1104(a5) # 80204010 <ticks>
		    if(num==10){
    80200468:	6018                	ld	a4,0(s0)
    8020046a:	47a9                	li	a5,10
    8020046c:	fcf711e3          	bne	a4,a5,8020042e <interrupt_handler+0x6a>
}
    80200470:	6402                	ld	s0,0(sp)
    80200472:	60a2                	ld	ra,8(sp)
    80200474:	0141                	addi	sp,sp,16
			    sbi_shutdown();
    80200476:	a3bd                	j	802009e4 <sbi_shutdown>
...
void exception_handler(struct trapframe *tf) {
    ...
    80200490:	02e79563          	bne	a5,a4,802004ba <exception_handler+0x42>
    ...
    80200498:	b0c50513          	addi	a0,a0,-1268 # 80200fa0 <etext+0x574>
    8020049c:	bd5ff0ef          	jal	ra,80200070 <cprintf>
	    cprintf("Illegal instruction caught at %d",tf->badvaddr);
    802004a0:	11043583          	ld	a1,272(s0)
    802004a4:	00001517          	auipc	a0,0x1
    802004a8:	b2450513          	addi	a0,a0,-1244 # 80200fc8 <etext+0x59c>
    802004ac:	bc5ff0ef          	jal	ra,80200070 <cprintf>
	    tf->epc+=4;
    ...
    802004ce:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004d0:	bd51                	j	80200364 <print_trapframe>
	    cprintf("Exception type:breakpoint\n");
    802004d2:	00001517          	auipc	a0,0x1
    802004d6:	b1e50513          	addi	a0,a0,-1250 # 80200ff0 <etext+0x5c4>
    802004da:	b97ff0ef          	jal	ra,80200070 <cprintf>
	    cprintf("ebreak caught at %d",tf->badvaddr);
    802004de:	11043583          	ld	a1,272(s0)
    802004e2:	00001517          	auipc	a0,0x1
    802004e6:	b2e50513          	addi	a0,a0,-1234 # 80201010 <etext+0x5e4>
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    80200508:	bf85                	j	80200478 <exception_handler>
        interrupt_handler(tf);
    8020050a:	bd6d                	j	802003c4 <interrupt_handler>
