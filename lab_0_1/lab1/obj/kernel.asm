...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200424:	00d78c63          	beq	a5,a3,8020043c <interrupt_handler+0x7e>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200434:	a9850513          	addi	a0,a0,-1384 # 80200ec8 <etext+0x520>
    ...
    8020044e:	a6e50513          	addi	a0,a0,-1426 # 80200eb8 <etext+0x510>
		    num+=1;
    ...
    80200466:	fcf711e3          	bne	a4,a5,80200428 <interrupt_handler+0x6a>
}
    8020046a:	6402                	ld	s0,0(sp)
    8020046c:	60a2                	ld	ra,8(sp)
    8020046e:	0141                	addi	sp,sp,16
			    sbi_shutdown();
    80200470:	a9c5                	j	80200960 <sbi_shutdown>

0000000080200472 <trap>:
    }
}
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    80200476:	0007c763          	bltz	a5,80200484 <trap+0x12>
    switch (tf->cause) {
    8020047a:	472d                	li	a4,11
    8020047c:	00f76363          	bltu	a4,a5,80200482 <trap+0x10>
...
void trap(struct trapframe *tf) { trap_dispatch(tf); }
    80200480:	8082                	ret
            print_trapframe(tf);
    80200482:	bdf1                	j	8020035e <print_trapframe>
        interrupt_handler(tf);
    80200484:	bf2d                	j	802003be <interrupt_handler>
	...
...
__alltraps:
    ...
    jal trap
    802004ec:	f87ff0ef          	jal	ra,80200472 <trap>
